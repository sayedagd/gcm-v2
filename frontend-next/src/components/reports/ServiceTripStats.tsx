            ...
            render: (val: string) => {
                ...
                return (
                    <div className="space-y-1">
                        <Link href={`/projects?id=${project?.project_id}`} className="font-bold text-text-main flex items-center gap-2 hover:text-primary transition-colors hover:underline" onClick={e => e.stopPropagation()}>
                            <Briefcase size={14} className="text-primary" />
                            {project?.project_name || val || '---'}
                        </Link>
                        <Link href={`/companies?id=${company?.company_id}`} className="text-[10px] font-bold text-text-subtle tracking-widest uppercase hover:text-primary transition-colors block" onClick={e => e.stopPropagation()}>
                ...
                <div className="space-y-2">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <Link href={`/drivers?id=${trip.driver_id}`} className="font-bold text-text-main text-[11px] hover:text-primary hover:underline transition-colors" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <Link href={`/fleet?id=${trip.vehicle_id}`} className="font-bold text-text-main text-[11px] hover:text-primary hover:underline transition-colors" onClick={e => e.stopPropagation()}>
