            ...
            <div className="flex-1 mt-4">
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <Link href={`/dr?id=${staff.driver_id}`} onClick={e => e.stopPropagation()} className="block text-lg sm:text-lg font-bold tracking-tight truncate text-text-main hover:text-primary transition-colors leading-tight max-w-[160px] focus:outline-none">{staff.name}</Link>
                    </div>
