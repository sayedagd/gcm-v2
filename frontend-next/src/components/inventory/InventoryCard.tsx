            ...
            <div className={`p-8 ${viewType === 'list' ? 'flex-1 p-0' : ''}`}>
                <div className="flex justify-between items-start mb-6">
                    <div className="space-y-1">
                        ...
                        <Link href={`/iv?id=${id}`} onClick={e => e.stopPropagation()} className="block text-2xl font-black text-text-main hover:text-blue-500 transition-colors tracking-tight leading-tight focus:outline-none">
