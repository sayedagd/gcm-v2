...
const AISessions: React.FC = () => {
    ...
    const statusConfig: Record<'completed' | 'cancelled' | 'failed' | 'report_only', { color: string; icon: React.ReactNode; label: string; labelAr: string }> = {
    ...
    const defaultStatusConfig = statusConfig.completed;

    const StatusBadge = ({ status }: { status: string }) => {
        const cfg = status in statusConfig
