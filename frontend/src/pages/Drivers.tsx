  ...
  const handleSave = async (staff: Driver, permits: PermitEntry[]) => {
    ...
    try {
      ...
      const driverToSave: Driver = {
        ...
        vehicle_id: staff.vehicle_id || null,
        supplier_id: currentUser.role === Role.SUBCONTRACTOR ? currentUser.supplier_id : staff.supplier_id,
        ...
        license_expiry: toDate(staff.license_expiry),
        iqama_expiry: toDate(staff.iqama_expiry),
        operating_card_expiry: toDate(staff.operating_card_expiry),
        insurance_expiry: toDate(staff.insurance_expiry),
      };
