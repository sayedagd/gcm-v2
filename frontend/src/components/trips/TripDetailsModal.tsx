    ...
    return (
        <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                                ...
                                <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-base font-bold text-text-main">
                                            {companyMap[projectMap[selectedTrip.project_id]?.company_id]?.company_name || '---'}
                                        </p>
                                    </div>
                                    <div>
                            ...
                            <div className="bg-surface rounded-3xl border border-border overflow-hidden shadow-sm">
                                ...
                                <div className="p-5">
                                    {(() => {
                                        ...
                                        const supplier = isExternal ? supplierMap[vehicle.supplier_id] : null;
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-surface-subtle border border-border">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p
                                                                ...
                                                                onClick={() => currentUser.role === Role.ADMIN && navigate(`/f?id=${selectedTrip.vehicle_id}`)}
                                                            >
                                                                {vehicle?.plate_no || '---'}
                                                            </p>
                                                    ...
                                                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-surface-subtle border border-border">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p
                                                                className={`text-lg font-bold text-text-main ${currentUser.role === Role.ADMIN ? 'cursor-pointer hover:text-emerald-500 underline decoration-emerald-500/30 transition-colors' : ''}`}
                                                                onClick={() => currentUser.role === Role.ADMIN && navigate(`/dr?id=${selectedTrip.driver_id}`)}
                                                            >
                                                                {driver?.name || '---'}
                                                            </p>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 p-5 shadow-sm">
                                ...
                                {(() => {
                                    const baseImages = safeParseArray(selectedTrip.proof_images) || [];
                                    ...
                                    const images = Array.from(new Set([...baseImages, ...containerImages]));
            ...
            <SignatureApproveModal
                ...
                intendedSigner={signatureModalTrip?.signer}
