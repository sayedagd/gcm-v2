...
const getPageResults = (isAr: boolean): SearchResult[] => [
  { id: 'p-db', label: isAr ? 'الرئيسية' : 'Dashboard', sublabel: isAr ? 'مركز القيادة' : 'Command Center', icon: LayoutDashboard, href: '/db', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-c', label: isAr ? 'الشركات' : 'Companies', sublabel: isAr ? 'إدارة العملاء' : 'Client Management', icon: Building2, href: '/c', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-p', label: isAr ? 'المشاريع' : 'Projects', sublabel: isAr ? 'مواقع العمل' : 'Job Sites', icon: Briefcase, href: '/p', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-t', label: isAr ? 'الرحلات' : 'Trips', sublabel: isAr ? 'العمليات الميدانية' : 'Field Operations', icon: ClipboardList, href: '/t', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-f', label: isAr ? 'الأسطول' : 'Fleet', sublabel: isAr ? 'المركبات والمعدات' : 'Vehicles & Equipment', icon: Truck, href: '/f', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-iv', label: isAr ? 'المخزون' : 'Inventory', sublabel: isAr ? 'الحاويات والخزانات' : 'Containers & Tanks', icon: Package, href: '/iv', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-dr', label: isAr ? 'الموظفين' : 'Staff Hub', sublabel: isAr ? 'السائقين والمشرفين' : 'Drivers & Supervisors', icon: HardHat, href: '/dr', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-rd', label: isAr ? 'التقارير' : 'Reports', sublabel: isAr ? 'التحليلات المتقدمة' : 'Advanced Analytics', icon: BarChart3, href: '/rd', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-s', label: isAr ? 'الخدمات' : 'Services', sublabel: isAr ? 'كتالوج الخدمات' : 'Service Catalog', icon: Box, href: '/s', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-u', label: isAr ? 'الفريق' : 'Team', sublabel: isAr ? 'إدارة المستخدمين' : 'User Management', icon: Users, href: '/u', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-l', label: isAr ? 'سجل الأنشطة' : 'Activity Logs', sublabel: isAr ? 'تتبع العمليات' : 'Audit Trail', icon: ScrollText, href: '/l', category: isAr ? 'صفحات' : 'Pages' },
  { id: 'p-st', label: isAr ? 'الإعدادات' : 'Settings', sublabel: isAr ? 'إعدادات النظام' : 'System Configuration', icon: Settings, href: '/st', category: isAr ? 'صفحات' : 'Pages' },
];
