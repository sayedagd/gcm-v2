            ...
            <div className="space-y-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <Link to={`/fleet?id=${vehicle.vehicle_id}`} onClick={e => e.stopPropagation()} className="block text-xl sm:text-2xl font-black tracking-widest text-text-main hover:text-primary transition-colors uppercase leading-tight truncate focus:outline-none">
                            {vehicle.plate_no}
                        </Link>
